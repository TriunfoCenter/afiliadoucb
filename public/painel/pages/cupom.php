...
$sql = "SELECT * FROM cupom ORDER BY id DESC";
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Listagem de Cupons</h4>
...
<tr>
  ...
  <td> <?php echo $dado['codigocupom']; ?> </td>
  <td> <?php echo $dado['validopara']; ?> </td>
  <td> <?php echo $dado['porcentagemdedesconto']; ?> </td>
  <td> <?php echo $dado['criadoem']; ?> </td>
  <td> <?php echo $dado['criadopor']; ?> </td>
  <td> 
