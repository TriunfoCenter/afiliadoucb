...
<html lang="en">
  ...
  <body>
    ...
    <img src="../../assets/images/faces-clipart/pic-1.png" alt="image" />
        ...
        <td>
            <span class="ps-2"><?php echo $produto['modelo'] . ' ' . $produto['marca']. ' ' . $produto['tamanho']; ?></span>
        </td>
        <td>
            <?php echo $produto['valoratual']; ?>
        </td>
        <td>
            <?php echo $produto['valoranterior']; ?>
        </td>
        <td>
            <?php echo $produto['valorpix']; ?>
        </td>
        <td>
            <?php echo $produto['quantidadevisitas']; ?>
        </td>
        <td>
